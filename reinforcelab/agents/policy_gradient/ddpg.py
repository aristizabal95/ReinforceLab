...
class DDPG(Agent):
    def __init__(self, env: Env, actor_model: nn.Module, critic_model: nn.Module, learning_rate=0.01, discount_factor=0.999, alpha=0.03, batch_size=128, update_every=4, max_buffer_size=2**12, n_steps=0):
        ...
        buffer = ExperienceReplay({"batch_size": batch_size, "max_size": max_buffer_size, "n_steps": n_steps})
