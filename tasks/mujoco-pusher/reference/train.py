...
if __name__ == "__main__":
    ...
    agent = DDPGAgent(env, gamma=0.999, alpha=0.01, actor_lr=0.001, critic_lr=0.001, batch_size=512, update_every=64)
    path = f"{env.spec.id}-{agent.__class__.__name__}"

    train(env, agent, path, epsilon=1., num_epochs=50000, epsilon_decay=1e-6, min_epsilon=0.1)
    agent.load(path)
